...
import com.example.read_book.create_chapter_screen;
import com.example.read_book.model.Chapter;
import com.example.read_book.read_book_chapter_screen;

import java.util.List;

public class chapterAdapter_detail_createchapter extends RecyclerView.Adapter<chapterAdapter_detail_createchapter.chapter_ViewHolder>{

    private List<Chapter> chapter_model;
    private Context context_model;

    public chapterAdapter_detail_createchapter() {
    }
    ...
    @NonNull
    @Override
    public chapterAdapter_detail_createchapter.chapter_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull chapterAdapter_detail_createchapter.chapter_ViewHolder holder, int position) {
        ...
        holder.layout_choose_chapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context_model, create_chapter_screen.class);
